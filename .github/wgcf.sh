...
rm -f ${GITHUB_WORKSPACE}/files/wgcf-latest-linux-amd64 ${GITHUB_WORKSPACE}/files/wgcf-latest-linux-arm64 ${GITHUB_WORKSPACE}/files/wgcf-latest-linux-s390x ${GITHUB_WORKSPACE}/files/wgcf-fetchlog.txt
